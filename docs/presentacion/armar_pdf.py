...
<div class="page">
  ...
  <div class="pie"><span>AntiGro · Documento de presentación</span><span>1 / 4</span></div>
</div>
...
<div class="page">
  ...
  <div class="pie"><span>AntiGro · Documento de presentación</span><span>2 / 4</span></div>
</div>
...
<div class="page">
  ...
  <div class="pie"><span>AntiGro · Documento de presentación</span><span>3 / 4</span></div>
</div>

<!-- ═══════════ PÁGINA 4 — en qué se basa y hacia dónde va ═══════════ -->
<div class="page">
  <div class="cinta"><span class="kicker">En qué se basa · estado · proyección</span><span class="kicker">AntiGro</span></div>
  <hr class="regla-fuerte">
  ...
  <div class="sec">
    ...
    <p style="margin-top:1.8mm">
      <strong>Y por dónde escala.</strong> El sistema está construido para que sumar una fuente sea conectar una
      entrada, no rehacer el motor. Las que ya están identificadas, con lo que cada una aportaría:
      <strong>edad del dominio</strong> (WHOIS / VirusTotal) — un chat registrado hace tres semanas no es lo mismo
      que uno de hace diez años, y hoy el motor los trata igual; <strong>reputación de dominio</strong> (abuse.ch,
      PhishTank) — con la salvedad de que detecta infraestructura maliciosa, no grooming, así que entra con peso
      bajo; <strong>taxonomías de organismos</strong> — NCMEC define <em>online enticement</em> como categoría
      paraguas, e Interpol, Europol y la UFECI publican modus operandi salidos de causas reales;
      <strong>tiempo de uso por aplicación</strong> (Screen Time de Apple, Digital Wellbeing de Android), que
      cubriría el punto ciego del DNS cuando una app resuelve nombres por su cuenta.
      <span style="opacity:.75">Ninguna de estas fuentes lee contenido: son metadatos, categorías y fechas. Y
      ninguna se presenta como disponible hoy — están enumeradas para mostrar por dónde crece, no para contarlas
      como funciones.</span>
    </p>
  ...
  <div class="pie"><span>AntiGro · Documento de presentación</span><span>4 / 4</span></div>
</div>
